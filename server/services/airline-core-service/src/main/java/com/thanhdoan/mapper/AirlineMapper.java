...
public class AirlineMapper {
  ...
  public static AirlineResponse toResponse(Airline airline) {
    ...
    return AirlineResponse.builder()
        ...
        // .supportEmail(airline.getSupport() != null ? airline.getSupport().getEmail()
        // : null)
        // .supportPhone(airline.getSupport() != null ? airline.getSupport().getPhone()
        // : null)
        // .supportHours(airline.getSupport() != null ? airline.getSupport().getHours()
        // : null)
        .support(airline.getSupport())
